        ...
        <?php foreach ($types as $type): ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= BASE_URL . htmlspecialchars(rawurlencode($type['name'])) ?>/add" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Adicionar</a>
                    <a href="<?= BASE_URL . htmlspecialchars(rawurlencode($type['name'])) ?>" class="btn btn-sm btn-secondary"><i class="fa fa-list"></i> Listar</a>
